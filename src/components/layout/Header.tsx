      ...
      <div className="max-w-[1920px] mx-auto px-4 lg:px-6 py-2.5 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="relative">
            ...
            {/* City Dropdown Menu */}
            {cityDropdownOpen && (
              <div className="absolute top-full left-0 mt-2 w-72 rounded-3xl bg-white border-2 border-slate-200 shadow-2xl p-2 z-[6000] animate-in fade-in-50 slide-in-from-top-2">
                
                {/* Location Detection & Add City Shortcuts */}
                <div className="p-1 pb-2 border-b border-slate-100 space-y-1">
                  <button
                    onClick={() => {
                      setIsLocationModalOpen(true);
                      setCityDropdownOpen(false);
                    }}
                    className="w-full flex items-center justify-between p-2 rounded-xl bg-emerald-50 hover:bg-emerald-100 text-emerald-900 text-xs font-bold transition cursor-pointer"
                  >
                    <div className="flex items-center gap-2">
                      <Navigation2 className="w-3.5 h-3.5 text-emerald-600" />
                      <span>🛰️ Detect My GPS Location</span>
                    </div>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between p-2 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-900 text-xs font-bold transition cursor-pointer"
                  >
                    <div className="flex items-center gap-2">
                      <Plus className="w-3.5 h-3.5 text-indigo-600" />
                      <span>➕ Add Custom City</span>
                    </div>
                    <span className="text-[10px] text-indigo-700">Anywhere</span>
                  </button>
                </div>

                <div className="px-3 py-1.5 text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                  Available Digital Twin Metros ({allCitiesList.length})
                </div>
          ...
          <button
            ...
            className="hidden md:flex items-center gap-1.5 px-2.5 py-1.5 rounded-2xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold border border-slate-200 transition cursor-pointer"
            title="Detect GPS or Add Custom Location"
          >
